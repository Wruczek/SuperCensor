...
public class StringUtils {
	...
	public static boolean checkRegex(String regex, String string, boolean extraPrecautions) {
		String specialCharsRegex = "[^!@#$%^&*-.]*";
		String newregex = specialCharsRegex + "(" + regex + ")" + specialCharsRegex;

		boolean enchantedRegex = checkRegex(newregex, string);

		if (!extraPrecautions || !enchantedRegex) {
